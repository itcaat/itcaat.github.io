...
```
### 7. Делайте манифесты небольшими
...
{{< callout emoji="⚡️" text="Тут важно понимать, что речь про организационную атомарность (в одном файле/изменении), а НЕ как гарантия Kubernetes 'все ресурсы применились или ни один'." >}}
