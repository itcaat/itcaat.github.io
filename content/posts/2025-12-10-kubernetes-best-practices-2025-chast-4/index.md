...
**Серия:** Часть 4 из 6. (Ссылки на остальные части можно проставить после объединения.)

### В этой части
- [Автомасштабирование (42–45)](#autoscaling)
- [Хранилище (46–48)](#storage)
- [Планирование/размещение (49–52)](#scheduling)
- [Контейнерные паттерны (53–55)](#patterns)
